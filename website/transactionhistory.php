  ...
  ?>
    ...
    <table class="table table-hover table-striped table-condensed table-bordered">
        ...
        ?>
            ...
            <tr>
            <td class="py-2"><font color="#393e46"><?php echo $rows['sno']; ?></font></td>
            <td class="py-2"><font color="#393e46"><?php echo $rows['sender']; ?></font></td>
            <td class="py-2"><font color="#393e46"><?php echo $rows['receiver']; ?></font></td>
